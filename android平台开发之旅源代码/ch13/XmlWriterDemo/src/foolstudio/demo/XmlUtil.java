...
public class XmlUtil {
	...
	*/
	...
	private void defineUserInfoTable1(Document doc, Element root) {
		...
		//定义表字段
		defineField(doc, table, "ui_id", "32", "NOT", "0", ""); //Id
		defineField(doc, table, "ui_password", "32", "NOT",	"pt950", ""); //密码
		defineField(doc, table, "ui_sex", "8", "NOT", "Male", ""); //性别
		defineField(doc, table, "ui_hobby", "200", "", "RESERVED", "|"); //爱好
	...
	private void defineDutyInfoTable1(Document doc, Element root) {
		...
		//定义表字段
		defineField(doc, table, "di_id", "4", "NOT", "0", ""); //Id
		defineField(doc, table, "di_class", "4", "NOT", "0", ""); //职位
		defineField(doc, table, "di_desc", "128", "NOT", "RESERVED", ""); //职位描述
	...
	private void defineField(Document doc, Element table, String name, 
			String type, String nullVal, String defaultVal, String separator) {
		Element field = doc.createElement("Field");
		table.appendChild(field);

		//添加字段属性
		field.setAttribute("NAME", name);
		field.setAttribute("MAX_SIZE", type);
		field.setAttribute("NULL", nullVal);
