...
public class Tree {
  ...
  private void draw()
  {
   ...
   Oval oval1=new Oval( this.x,this.y+(int)(10*this.scale),(int)this.scale*10,(int)this.scale*10,Color.red,true);
   Oval oval2=new Oval( this.x,this.y-(int)(30*this.scale),(int)this.scale*10,(int)this.scale*10,Color.yellow,true);
   Oval oval3=new Oval( this.x+(int)(36*this.scale),this.y-(int)(5*this.scale),(int)this.scale*10,(int)this.scale*10,Color.blue,true);
