...
public class SnowMan {
	 ...
	 * 
	 * @param x
	 *            the x coordinate of the center of the head of the snow man
	 * @param y
	 *            the y coordinate of the center of the head of the snow man
	 * @scale the factor that multiplies all default dimensions for this snow
	...
	private void draw() {
		// draw head
		head = new Oval((int) ((this.x - h_radius) * scale),
				(int) ((this.y - h_radius) * scale),
				(int) (2 * h_radius * scale), (int) (2 * h_radius * scale),
				Color.white, true);
		this.window.add(head);

		// draw body
		body = new Oval((int) ((this.x - b_radius) * scale),
				(int) ((this.y + 20) * scale), (int) (2 * b_radius * scale),
				(int) (2 * b_radius * scale), Color.white, true);
		this.window.add(body);

		// draw nose
		nose = new Triangle((int) (this.x * scale), (int) (this.y * scale),
				(int) ((this.x - n_width) * scale),
				(int) ((this.y + n_width * 2) * scale),
				(int) ((this.x + n_width) * scale),
				(int) ((this.y + n_width * 2) * scale), Color.orange, true);
		this.window.add(nose);

		// draw left eyes
		l_eye = new Oval((int) ((this.x - 3 * e_radius) * scale),
				(int) ((this.y - n_width * 2) * scale),
				(int) (2 * e_radius * scale), (int) (2 * e_radius * scale),
				Color.black, true);
		this.window.add(l_eye);

		// draw right eyes
		r_eye = new Oval((int) ((this.x + e_radius) * scale),
				(int) ((this.y - n_width * 2) * scale),
				(int) (2 * e_radius * scale), (int) (2 * e_radius * scale),
				Color.black, true);
		...
		// draw the mouth
		mouth = new Rectangle((int) ((this.x - m_width / 2) * scale),
				(int) ((this.y + 16) * scale), (int) (m_width * scale),
				(int) (m_height * scale), Color.black, true);
		this.window.add(mouth);

		// draw the brim
		brim = new Rectangle((int) ((this.x - b_width / 2) * scale),
				(int) ((this.y - 27) * scale), (int) (b_width * scale),
				(int) (b_height * scale), Color.yellow, true);
		this.window.add(brim);

		// draw the hat
		hat = new Rectangle((int) ((this.x - t_width / 2) * scale),
				(int) ((this.y - 27 - t_height) * scale),
				(int) (t_width * scale), (int) (t_height * scale), Color.red,
				true);
		this.window.add(hat);

		// draw button
		button2 = new Oval((int) ((this.x - e_radius) * scale), (int) ((this.y
				+ 20 + b_radius - e_radius) * scale),
				(int) ((2 * e_radius) * scale), (int) ((2 * e_radius) * scale),
				Color.black, true);
		this.window.add(button2);
		button1 = new Oval((int) ((this.x - e_radius) * scale), (int) ((this.y
				+ 20 + b_radius / 2 - e_radius) * scale),
				(int) ((2 * e_radius) * scale), (int) ((2 * e_radius) * scale),
				Color.black, true);
		this.window.add(button1);
		button3 = new Oval((int) ((this.x - e_radius) * scale),
				(int) ((this.y + 20 + b_radius * 3 / 2) * scale),
				(int) ((2 * e_radius) * scale), (int) ((2 * e_radius) * scale),
				Color.black, true);
		this.window.add(button3);

		// draw left hands
		l_hand = new Line((int) ((this.x - h_radius) * scale), (int) ((this.y
				+ 20 + b_radius / 2 - e_radius) * scale), (int) ((this.x
				- h_radius - h_length) * scale), (int) ((this.y + 20 + b_radius
				/ 2 - e_radius) * scale));
		this.window.add(l_hand);

		// draw right hands
		r_hand = new Line((int) ((this.x + h_radius) * scale), (int) ((this.y
				+ 20 + b_radius / 2 - e_radius) * scale), (int) ((this.x
				+ h_radius + h_length) * scale), (int) ((this.y + 20 + b_radius
				/ 2 - e_radius) * scale));
		...
		// draw left finger
		l_finger = new Line(
				(int) ((this.x - h_radius - h_length + 20) * scale),
				(int) ((this.y + 20 + b_radius / 2 - e_radius) * scale),
				(int) ((this.x - h_radius - h_length) * scale), (int) ((this.y
						+ 20 + b_radius / 2 - e_radius - 10) * scale));
	...
	// move snow man inside the window
	...
	public void rotateHand() {
		angle += 100;
		l_finger.rotateAround(
				(int) ((this.x - h_radius - h_length + 20) * scale),
				(int) ((this.y + 20 + b_radius / 2 - e_radius) * scale), angle);
		r_finger.rotateAround(
				(int) ((this.x + h_radius + h_length - 20) * scale),
				(int) ((this.y + 20 + b_radius / 2 - e_radius) * scale), angle);
	}
}
