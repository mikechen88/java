 ...
 * 
 * Birth - anything added to the simulation on the previous cycle are added to
 * the world.<br>
 * 
 ...
 * <p>
 */
public class DrawingModle implements Cloneable {
	// instance variables
	private ArrayList<AbstractShape> things; // List of all SimThings in this
												// model
	 ...
	 * the current cycle.
	 */
	public List<AbstractShape> getThings() {		
